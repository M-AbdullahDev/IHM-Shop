        ...
        tbody.innerHTML = rows.map(row => {
            ...
            return `
                <tr style="${row.isProjected ? 'background: rgba(255, 255, 255, 0.015); font-style: italic;' : ''}">
                    ...
                    <td style="font-weight: 700; color: var(--accent-success);">${profitText}</td>
                    <td style="font-weight: 700; ${marginStyle}">${s.margin.toFixed(1)}%</td>
                </tr>
            `;
        }).join('');
    },
